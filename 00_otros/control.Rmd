...
[Packrat](https://rstudio.github.io/packrat/) es un sistema de administración de dependencias para R que busca eliminar los problemas que suele haber para utilizar código realizado en diferentes momentos o máquinas con diferentes versiones de las librerías, entre los típicos son:
...
Aquí agrega lo que necesita a las carpetas mencionados antes para poder recrear las versiones y dependencias. También modifica el archivo `packrat.lock`.
...
Muévete a la carpeta `packrat/`
Borra la librería `rm -R lib/`
