...
Otra función útil es `str` pues permite desplegar en forma compacta la estrucutra
...
Como en vectores y matrices, \texttt{[[} quita los nombres o atributos y permite extraer
únicamente un elemento a la vez. En listas, además, devuelve el objeto dentro 
...
```{r}
set.seed(2887)
respuestas <- sample(x = c(1:5), size = 500, replace =  T, prob = c(0.1, 0.15, 0.2, 0.4, 0.15))
y <- factor(
  x = respuestas,
  levels = c("1", "2", "3", "4", "5"),
