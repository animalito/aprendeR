...
Nota como el método `plot.density` viene del paquete `stats`^[Hay otro tipo de funciones en las accesar al código fuente no se pueda con los métodos descritos. Para ello, es útil revisar la sección "old-school object-oriented programming in R" [@adler2010r; p. 131-133] o las secciones dedicadas a los objetos S3 y S4 en @wickham2014advanced.].
