...
[la documentación](http://rmarkdown.rstudio.com/html_document_format.html#overview) \parencite{rmarkdownhtml}.
...
código no se imprima y que solo se imprima el resultado:
