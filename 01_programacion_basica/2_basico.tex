...
\NormalTok{res <-}\StringTok{ }\KeywordTok{by}\NormalTok{(diamonds[, }\KeywordTok{c}\NormalTok{(}\StringTok{"carat"}\NormalTok{)], }
          \KeywordTok{list}\NormalTok{(}\DataTypeTok{cut =} \KeywordTok{as.factor}\NormalTok{(diamonds}\OperatorTok{$}\NormalTok{cut), }\DataTypeTok{color =} \KeywordTok{as.factor}\NormalTok{(diamonds}\OperatorTok{$}\NormalTok{color))}
