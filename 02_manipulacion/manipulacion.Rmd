...
categorías de edad.
Para arreglarlo, necesitamos *juntar* (melt) las columnas con valores de
...
`gather` de manera que obtenemos una tabla como la que se muestra en la tabla
...
valor (el diagnóstico i-ésima, el j-ésimo género y el k-ésimo grupo de edad) 
y, por último, especificamos
las variables que **NO** se deben de juntar (en este caso, el país, su iso2, su 
iso3 y el año).

Hay parámetros adicionales en la función. Para estos datos en particular, es
...
variables métdodo de diagnóstico, género y categoría de edad de la columna
...
los nuevos nombres de columnas (parámtro *into*) y la expresión regular con 
...
d1 (día 1), d2 (día 2), etc. Esto es homógolo al problema 1 visto anteriormente.
