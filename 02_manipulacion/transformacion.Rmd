...
necesario generar un objeto diferente al tradicional data.frame. Básicamente,
el tbl_df es capaz de guardar agrupamientos específicos sobre los cuáles 
puede hacer window functions o resumenes sobre los grupos que se definen.

#### Ejemplo {#ejemplo}

Los datos de vuelos se agrupan naturalmente sobre las aerolineas.
