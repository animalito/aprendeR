...
%% ----------------------------------------------------------------
\title{aprendeR}
\author{\normalsize{Andrea Fernández Conde}\\}
\date{\small{2 de julio de 2017}}
...
\input{00_otros/introduccion}

\chapter{R: lo básico}
\graphicspath{{01_programacion_basica/}}
\input{01_programacion_basica/1_basico} 

\chapter{Estructuras y funciones}
\graphicspath{{01_programacion_basica/}}
\input{01_programacion_basica/1b_basico} 

\chapter{Vectorización, la familia apply y otros}
\graphicspath{{01_programacion_basica/}}
\input{01_programacion_basica/2_basico}

\chapter{Herramientas básicas para un proyecto de datos}
\graphicspath{{02_manipulacion/}}
\input{02_manipulacion/importacion}
\input{02_manipulacion/transformacion}
\input{02_manipulacion/manipulacion}

\graphicspath{{03_visualizacion/}}
\input{03_visualizacion/ggplot2}

\chapter{Conclusión}
\graphicspath{{00_otros/}}
\input{00_otros/conclusion}
...
\input{00_otros/markdown}

\chapter{Packrat}\label{apendice-packrat}
\input{00_otros/control}
